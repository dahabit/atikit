...
// Company
function addCompany( $name, $address, $logo)
{
	$x1 = 10;
	$y1 = 42;

	$this->SetXY( 10, 0 );
	$this->Image($logo, null, null, 80, 40);
	$this->SetXY( $x1, $y1 );
...
function fact_dev($num, $text = "Invoice #")
{
    $r1  = $this->w - 80;
    $r2  = $r1 + 68;
    $y1  = 6;
...
function addReglement( $mode )
{
	...
	$this->SetFont( "Arial", "B", 10);
	$this->Cell(10,4, "TERMS OF PAYMENT", 0, 0, "C");
...
function addNumTVA($tva)
{
	...
	$this->Cell(40, 4, "SERVICING COMPANY", '', '', "C");
	$this->SetFont( "Arial", "", 10);
